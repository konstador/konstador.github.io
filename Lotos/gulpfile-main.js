var gulp       = require('gulp'), // Подключаем Gulp
    ...
    bourbon      = require('bourbon').includePaths, // Array of Bourbon paths
...
gulp.task('sass', function() { // Создаем таск Sass
    return gulp.src('app/sass/**/*.scss') // Берем источник
        ...
        .pipe(sourcemaps.write())//для sourcemap
...
gulp.task('prebuild', async function() {
    ...
    var buildFonts = gulp.src('app/fonts/**/*.+(eot|ttf|woff|woff2)') // Переносим шрифты в продакшен
